...
export const journalPapers: Publication[] = [
  ...
  },
  {
    ...
    abstract: "This paper presents one of the world's first real-world prototyping efforts for Reconfigurable Intelligent Surfaces (RIS). We built a custom RIS prototype and conducted extensive indoor and outdoor field trials, demonstrating the practical feasibility of RIS-aided wireless communications. Our adaptive beamforming algorithm was validated through real-world measurements, showing significant performance gains in both signal strength and coverage. This work received the prestigious 2024 IEEE Stephen O. Rice Prize and was recognized as an ESI Highly Cited Paper.",
  },
  {
  ...
  },
  {
    ...
    abstract: "This work proposes a coordinated approach to channel estimation in large-scale multiple-antenna systems. By jointly exploiting the sparsity structure in both angular and power domains, we develop efficient estimation algorithms that significantly outperform conventional approaches. The proposed method addresses fundamental challenges in massive MIMO systems and has become a foundational reference in the field, recognized as an ESI Highly Cited Paper with broad impact on subsequent research.",
  },
];
...
export const conferencePapers: Publication[] = [
  ...
  },
  {
    ...
    year: "Sept. 2021",
    highlight: "Invited",
    abstract: "This invited paper presents measurement-based validation of received power models for Reconfigurable Intelligent Surfaces (RIS). Through extensive real-world measurements, we characterize the RIS reflection behavior and develop accurate received power models that account for practical deployment factors. Our field trial results provide valuable insights for RIS system design and deployment in real environments.",
  },
  {
    authors: "Y. Cui, H. Yin",
